...
HD_PWD='C:/Users/root/Downloads/rasterizer_ee712_project/rasterizer_ee712_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rasterizer_ee712_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rasterizer_ee712_wrapper.tcl -notrace
