...
HD_PWD='C:/Users/root/Downloads/rasterizer_ee712_project/rasterizer_ee712_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rasterizer_ee712_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rasterizer_ee712_wrapper.tcl
