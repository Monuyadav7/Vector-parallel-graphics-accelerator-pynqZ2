...
//Command     : generate_target rasterizer_ee712.bd
//Design      : rasterizer_ee712
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "rasterizer_ee712,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=rasterizer_ee712,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=12,numReposBlks=12,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "rasterizer_ee712.hwdef" *) 
module rasterizer_ee712
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  wire [23:0]rasterizer20_1_m_axis_TDATA;
  wire rasterizer20_1_m_axis_TLAST;
  wire rasterizer20_1_m_axis_TREADY;
  wire rasterizer20_1_m_axis_TUSER;
  wire rasterizer20_1_m_axis_TVALID;
  ...
  assign locked_0 = v_axi4s_vid_out_0_locked;
  rasterizer_ee712_axi_gpio_0_0 axi_gpio_0
  ...
  rasterizer_ee712_clk_wiz_0_0 clk_wiz_0
  ...
  rasterizer_ee712_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  rasterizer_ee712_proc_sys_reset_1_0 proc_sys_reset_1
       (.aux_reset_in(1'b1),
  ...
  rasterizer_ee712_processing_system7_0_0 processing_system7_0
  ...
  rasterizer_ee712_rasterizer20_1_0 rasterizer20_1
       (.S_AXI_ACLK(processing_system7_0_FCLK_CLK0),
        ...
        .m_axis_tdata(rasterizer20_1_m_axis_TDATA),
        .m_axis_tlast(rasterizer20_1_m_axis_TLAST),
        .m_axis_tready(rasterizer20_1_m_axis_TREADY),
        .m_axis_tuser(rasterizer20_1_m_axis_TUSER),
        .m_axis_tvalid(rasterizer20_1_m_axis_TVALID));
  rasterizer_ee712_rgb2dvi_0_0 rgb2dvi_0
  ...
  rasterizer_ee712_smartconnect_0_0 smartconnect_0
  ...
  rasterizer_ee712_v_axi4s_vid_out_0_0 v_axi4s_vid_out_0
       (.aclk(processing_system7_0_FCLK_CLK0),
        .aclken(xlconstant_0_dout),
        .aresetn(axi_gpio_0_gpio_io_o),
        .fid(xlconstant_1_dout),
        .locked(v_axi4s_vid_out_0_locked),
        .s_axis_video_tdata(rasterizer20_1_m_axis_TDATA),
        .s_axis_video_tlast(rasterizer20_1_m_axis_TLAST),
        .s_axis_video_tready(rasterizer20_1_m_axis_TREADY),
        .s_axis_video_tuser(rasterizer20_1_m_axis_TUSER),
        .s_axis_video_tvalid(rasterizer20_1_m_axis_TVALID),
  ...
  rasterizer_ee712_v_tc_0_0 v_tc_0
  ...
  rasterizer_ee712_xlconstant_0_0 xlconstant_0
       (.dout(xlconstant_0_dout));
  rasterizer_ee712_xlconstant_1_0 xlconstant_1
